        ...
        for(var j = 0;j < goodsSorts;j++){
            for(var i in msg){
                if(msg[i].goodstype == $("div.type").eq(j).find("p").html()){
                    ...
                    str += '<a href="/details?id='+msg[i].id+'"><dl><dt><img src="'+msg[i].src+'" alt=""/></dt><dd><p class="descri">'+msg[i].name+'</p><p class="money">'+msg[i].price+'<span>'+msg[i].delprice+'</span></p></dd></dl></a>'
